# GAP-BundleResultatReponseADemandeConsultationRDV - Gestion d'Agendas Partagés (GAP) v3.0.0

## Resource Profile: GAP-BundleResultatReponseADemandeConsultationRDV 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.gap|current/StructureDefinition/StructureDefinition-gap-bundle-reponse-demande-consult-rdv.json)
...
Other representations of profile: [CSV](../StructureDefinition-gap-bundle-reponse-demande-consult-rdv.csv), [Excel](../StructureDefinition-gap-bundle-reponse-demande-consult-rdv.xlsx), [Schematron](../StructureDefinition-gap-bundle-reponse-demande-consult-rdv.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/gap/StructureDefinition/gap-bundle-reponse-demande-consult-rdv",
  "version" : "3.0.0",
